...
| `PlanRepository`             | `PostgresPlanRepositoryAdapter`                             |
| `RegimePlanPort`             | `HttpRegimePlanAdapter`                                     |
| `RegimeResultPort`           | `HttpRegimeResultAdapter`                                   |
...
| Position plans and result outbox               | Railway Postgres `position_plans` and `plan_execution_results` tables |
