    ...
    >
      ...
      <View style={{ marginTop: 16, gap: 16 }}>
        ...
        >
          ...
          >
            CLMM V2 is an LP exit assistant for Orca CLMM positions on Solana. It detects
            out-of-range positions, prepares directional unwind paths, and executes only after
        ...
        >
          ...
          <Text
            style={{ color: colors.textSecondary, fontSize: typography.fontSize.sm, marginTop: 4 }}
          >
            CLMM V2 never stores your private keys or signing authority. All transactions require
            explicit wallet signature. We cannot initiate transactions on your behalf.
          </Text>
        </View>
      </View>
    </ScrollView>
