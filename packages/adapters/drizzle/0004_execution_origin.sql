...
ALTER TABLE "execution_previews" ADD COLUMN "origin_kind" text NOT NULL;--> statement-breakpoint
...
ALTER TABLE "execution_attempts" ADD COLUMN "origin_kind" text NOT NULL;--> statement-breakpoint
...
ALTER TABLE "history_events" ADD COLUMN "origin_kind" text NOT NULL;--> statement-breakpoint
